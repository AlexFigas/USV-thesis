...
\begin{figure}[H]
    ...
    \caption[Comparação entre o robô didático original e a versão equipada com a \gls{pcb} desenvolvida.]{Comparação entre o robô didático original (esquerda) e a versão equipada com a \gls{pcb} desenvolvida (direita).}
