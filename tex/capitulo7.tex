...
A integração de sensores adicionais, tais como GNSS multiconstelação, câmaras ou radar de baixo custo, poderá reforçar a precisão da navegação e a capacidade de adaptação do sistema a ambientes marítimos mais complexos. Neste contexto, a incorporação de algoritmos de inteligência artificial para seguimento de objetos permitiria ao \gls{usv} identificar, rastrear e reagir automaticamente a alvos ou obstáculos, abrindo caminho para aplicações como monitorização ambiental, escolta de embarcações ou acompanhamento de fauna marinha. A utilização de redes neuronais treinadas em visão computacional ou sensores LiDAR poderá ser combinada com os sistemas de controlo existentes para ajustar a trajetória em tempo real, mantendo segurança e eficiência.  
